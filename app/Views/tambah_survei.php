...
<?= $this->include('layout/header') ?>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-10 wow fadeIn" data-wow-delay="0.3s">
								<h1 class="text-upper">SURVEY KEPUASAN MASYARAKAT BAPENDA PROVINSI LAMPUNG</h1>
								...
								<a href="#survei" class="btnsurvei" role="button" aria-pressed="true">Isi Survei</a>
							</div>
							<div class="col-md-1"></div>
						</div>
					</div>
    ...
    <section id="survei">
        <h1>Form Survey Kepuasan Masyarakat</h1>
